...
export default function RecipeEditor() {
  ...
  return (
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
      ...
      {/* LISTA DE PASOS */}
      <Panel title="Steps" className="col-span-1">
      ...
      {/* FORM SELECTED STEP */}
      <Panel title="Step Editor" className="col-span-1">
        {!selected ? (
          <div className="text-sm opacity-70">
      ...
      <Panel title="Recipe Meta & Publish" className="col-span-1">
