...
export default function ProfileEditor({ profileId, onClose }: Props) {
  ...
  return (
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
      ...
      {/* META */}
      <Panel title="Metadata" className="col-span-1">
        <ProfileMetaForm
          meta={meta}
      ...
      {/* PREVIEW */}
      <Panel title="Preview & Actions" className="col-span-1">
        <pre
          className="
      ...
      {/* SIGNAL MAP */}
      <Panel title="Signal Map" className="col-span-1 lg:col-span-3">
      ...
      {/* LIVE CAN INSPECTOR */}
      {meta.protocol === "CAN" && (
        <Panel title="🔍 Live CAN Inspector" className="col-span-1 lg:col-span-3">
          {selectedSignal ? (
            <CanFrameInspector
              byteOffset={offset}
              length={len}
