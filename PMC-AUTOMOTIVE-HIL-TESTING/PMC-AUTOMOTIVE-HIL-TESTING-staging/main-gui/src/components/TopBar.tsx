  ...
  return (
    ...
    >
      ...
      <span className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
        ...
        {pmcOnline ? (
          <span className="px-2 py-0.5 text-xs rounded bg-green-600 text-black font-semibold">
            ONLINE
          </span>
        ) : (
          <span className="px-2 py-0.5 text-xs rounded bg-red-700 text-white font-semibold">
            OFFLINE
          </span>
        )}
      </span>
      ...
      <nav className="flex gap-2">
        <Item id="run" label="Run" />
        <Item id="recipes" label="Recipes" />
        <Item id="profiles" label="Profiles" />
        <Item id="config" label="Config" />
        <Item id="signals" label="Signals" />
      </nav>
