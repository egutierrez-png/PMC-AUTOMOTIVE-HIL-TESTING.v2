...
type ModeSelectorPanelProps = {
  showDescription?: boolean;
  className?: string;
};

export default function ModeSelectorPanel({ showDescription = true, className = "" }: ModeSelectorPanelProps) {
  ...
  return (
    <Panel title="Modo de operación" className={className}>
